!function (e, n, a) {
    ...
    if (a(e).on("load", (function () {
        ...
        !1 === a.app.nav.initialized && a.app.nav.init({speed: 300}), Unison.on("change", (function (e) {
            a.app.menu.change()
        })), a('[data-toggle="tooltip"]').tooltip({container: "body"}), a(".navbar-hide-on-scroll").length > 0 && (a(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
        ...
        var l = a(".chartjs"), r = l.children("canvas").attr("height");
        l.css("height", r);
        ...
        a(".nav-link-search").on("click", (function () {
            ...
            var e = a(".search-input-close"), n = a(e).parent(".search-input"), t = a(".search-list");
        ...
        var o = n.querySelector(".drag-target"), l = "panright", r = "panleft";
    ...
    a(n).on("click", ".menu-toggle, .modern-nav-toggle", (function (n) {
        ...
        Unison.fetch.now()
    })), a(".navigation").find("li").has("ul").addClass("has-sub"), a(".carousel").carousel({interval: 2e3}), a(".nav-link-expand").on("click", (function (e) {
        ...
        var n = a(this), t = n.attr("href"), s = a(t).offset().top - 80;
        a("html, body").animate({scrollTop: s}, 0), setTimeout((function () {
